...
const LoginView: LoginViewType = ({ handleSubmit, isLoading }) => {
  return (
    ...
    >
      <h1 className="font-main font-normal text-[2rem] leading-tight pr-6 mb-10">
        Here, recycling is <br />
        simple, fast, and <br />
        totally worth <br />
      ...
      >
        ...
        <form className="flex flex-col gap-s">
          <h3 className="p-2 text-sm text-center">Sign in with your WorldID</h3>
          <Button
            disabled={isLoading}
            width="w-[90%]"
            type="submit"
